...
# argument 3~7 (if exist): for `define XPU_ARGUMENT in xpu_pre_def.v to enable some compiling time conditions
...
set files [list \
 ...
 "[file normalize "$origin_dir/src/ftm_time.v"]"\
...
set file "$origin_dir/src/fifo_sample_delay.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/src/ftm_time.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
